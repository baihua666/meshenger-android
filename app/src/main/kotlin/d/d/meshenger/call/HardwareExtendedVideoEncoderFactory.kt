...
class HardwareExtendedVideoEncoderFactory @JvmOverloads constructor(
    ...
    override fun getSupportedCodecs(): Array<VideoCodecInfo> {
        ...
        for (type in arrayOf(
            VideoCodecMimeType.H265, VideoCodecMimeType.AV1, VideoCodecMimeType.VP9, VideoCodecMimeType.VP8, VideoCodecMimeType.H264
...
//                            name, MediaCodecUtils.getCodecProperties(type,  /* highProfile= */true)
                            0, name, MediaCodecUtils.getCodecProperties(type,  /* highProfile= */true)
                        )
                    )
                }
                supportedCodecInfos.add(
...
//                        name, MediaCodecUtils.getCodecProperties(type,  /* highProfile= */false)
                        0, name, MediaCodecUtils.getCodecProperties(type,  /* highProfile= */false)
                    )
                )
            }
        }
